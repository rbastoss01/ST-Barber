    ...
    <div id="panel-proximas">
        @forelse($proximas as $cita)
            <div class="sb-cita-card">
                <div class="sb-cita-fecha-bloque">
                    ...
                    <div class="sb-cita-mes">{{ $cita->fecha->translatedFormat('M') }}</div>
                </div>
                ...
                <div class="d-flex flex-column align-items-end gap-2" style="flex-shrink:0;">
                    @php $badgeClass = match($cita->estado) {
                        'CONFIRMADA' => 'sb-badge-confirmada',
                        default      => 'sb-badge-cancelada',
                    }; @endphp
        ...
        @empty
            <div class="sb-empty">
                ...
                <p>Reserva tu próxima cita online en menos de un minuto.</p>
        ...
        @forelse($pasadas as $cita)
            <div class="sb-cita-card" style="opacity:.85;">
                <div class="sb-cita-fecha-bloque" style="background:#F3F4F6;">
                    ...
                    <div class="sb-cita-mes" style="color:#9CA3AF;">{{ strtoupper($cita->fecha->locale('es')->isoFormat('MMM')) }}</div>
                </div>
