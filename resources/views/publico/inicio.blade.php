...
<section class="sb-steps">
    <div class="container">
        <div class="mb-5">
            ...
            <p class="sb-section-sub">Reserva tu cita en tres pasos, desde cualquier dispositivo.</p>
        </div>
        <div class="row g-4 g-md-0">
            <div class="col-md-4">
                <div class="sb-step">
                    ...
                    <p class="sb-step-desc">Regístrate gratis en menos de 30 segundos. Solo necesitas tu nombre y correo.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="sb-step">
                    ...
                    <p class="sb-step-desc">Selecciona el servicio, el barbero y el horario que mejor te venga.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="sb-step">
                    ...
                    <p class="sb-step-desc">Llega a tu hora, sin esperas. Tu barbero te estará esperando.</p>
                </div>
            </div>
        </div>
    </div>
