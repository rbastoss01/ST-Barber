...
<head>
    ...
    <title>Recordatorio de cita - ST BARBER</title>
    <style>
        body {
...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p class="intro">
                Te recordamos que tienes una cita reservada con nosotros <strong>mañana</strong>.
            ...
            <p class="closing">
                Si necesitas cancelar o modificar tu cita, puedes hacerlo desde tu área de cliente
                en nuestra web con al menos 24 horas de antelación.<br><br>
                ¡Hasta mañana!<br>
                <strong>El equipo de ST BARBER</strong>
            </p>
        </div>
